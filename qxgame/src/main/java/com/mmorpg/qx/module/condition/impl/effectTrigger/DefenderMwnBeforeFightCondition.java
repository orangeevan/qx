 ...
 */
public class DefenderMwnBeforeFightCondition extends AbstractEffectTriggerCondition<Integer> {
    private Param param;

    @Override
    public TriggerType getTriggerType() {
        return TriggerType.MWN_BEFORE_FIGHT_DEFENDER;
    }
    ...
    protected void init() {
        ...
        param = JsonUtils.string2Object(params, DefenderMwnBeforeFightCondition.Param.class);
    }
