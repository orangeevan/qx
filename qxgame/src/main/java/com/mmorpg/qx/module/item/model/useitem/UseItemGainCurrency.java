 ...
 * @author zhang peng
 * @description
 * @since 11:08 2021/4/27
 */
@Component
public class UseItemGainCurrency extends AbstractUseItem {
    ...
    public void use(Player player, ItemResource resource, long objectId, int num) {
        ...
        RewardService.getInstance().grantReward(player, RewardType.PURSE, code, totalNum, moduleInfo);
    }
}
